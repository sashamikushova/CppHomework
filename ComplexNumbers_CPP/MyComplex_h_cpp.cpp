/* File MyComplex.h
definition of MyComplex class, kvadratne, kubichne and chetvertoho fuctions
...
MyComplex MyComplex::operator+(const MyComplex& c)const{ //operator overload (+,-,*,/)
            MyComplex c1;
            c1.real=real+c.real;
            c1.imag=imag+c.imag;
            return c1;
...
MyComplex MyComplex::mysqrt(){                                 //function for finding square root 
...
MyComplex    MyComplex::myconj(){                         //spryazhene complex number
            return MyComplex(real,-imag);
        }

MyComplex   MyComplex::mycbrt(){                                 //function for finding cubic root
             double magnitude = sqrt(real*real+imag*imag);
            double phase = atan2(imag, real);
